...
PAYMENT_METHOD_UNDEFINED_ID = int(os.getenv("PAYMENT_METHOD_UNDEFINED_ID"))
CAMP_CANCELED_CAMP_PARENT_TEMPLATE_ID = int(os.getenv("CAMP_CANCELED_CAMP_PARENT_TEMPLATE_ID"))
CAMP_STATUS_CANCELLED_ID = int(os.getenv("CAMP_STATUS_CANCELLED_ID"))
CAMP_CANCELED_CAMP_ADMIN_TEMPLATE_ID = int(os.getenv("CAMP_CANCELED_CAMP_ADMIN_TEMPLATE_ID"))
...
@camp_router.get("/camps/{camp_id}/medical_visit_report", tags=["Camps"])
def camp_extras_report(camp_id: int, db: Session = Depends(get_db)):

...
from schema.groupings.grouping_camper_schema import GroupingCamperCreate, GroupingCamperUpdate
...
@grouping_camper_router.get("/grouping_campers/", response_model=list[GroupingCamperCreate], tags=["GroupingCamper"])
def list_grouping_campers(db: Session = Depends(get_db)):
    return get_all_grouping_campers(db)

@grouping_camper_router.get("/grouping_campers/{grouping_camper_id}", response_model=GroupingCamperCreate, tags=["GroupingCamper"])
...
@grouping_camper_router.post("/grouping_campers/", response_model=GroupingCamperCreate, tags=["GroupingCamper"])
...
@grouping_camper_router.post("/grouping_campers/assign/", response_model=GroupingCamperCreate, tags=["GroupingCamper"])
...
@grouping_camper_router.put("/grouping_campers/{grouping_camper_id}", response_model=GroupingCamperUpdate, tags=["GroupingCamper"])
